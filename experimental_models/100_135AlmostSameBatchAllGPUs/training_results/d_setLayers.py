...
# Solver params
if sSuperModel:
    # sLearningRateInit = 5e-5 # Exploded
...
if sAddDome:
    ...
    # sProbabilities = "0.05;" + str(1.0-sProbabilityOnlyBackground-0.05-0.05-0.05-0.08-0.1) + ";0.05;0.01;0.01;0.03;0.02;0.06;0.1"
    #                 Foot                                      COCO                              MPII FRGC   MPIE  FACE  HDome HMPII Dome135
    # sProbabilities = "0.05;" + str(1.0-sProbabilityOnlyBackground-0.05-0.05-0.015-0.055-0.05) + ";0.05;0.005;0.005;0.005;0.005;0.05;0.05"
    #                 Foot                                      COCO                              MPII FRGC  MPIE FACE  HDome HMPII Dome135
